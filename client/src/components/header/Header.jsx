...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="nav-container h-20  fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-blue-700 via-blue-500 to-cyan-400 shadow-md">
              ...
              <div className="flex justify-between h-16 items-center">
                ...
                <div className="flex items-center ml-auto">
                  ...
                  <div className="hidden md:flex md:space-x-4 items-center text-2xl ml-6">
                    <Link to="/login" className="px-3 py-1.5 rounded-md text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700"> Login</Link>
